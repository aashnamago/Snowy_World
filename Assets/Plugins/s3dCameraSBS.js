...
public var zeroPrlxDist : float = 10.0; // Distance (in meters) at which left and right images overlap exactly
// View Parameters
...
public var H_I_T: float = 3.0; // Horizontal Image Transform - shift left and right image horizontally
